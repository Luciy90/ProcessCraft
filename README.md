...
│           │   ├── access-control.js   # Система контроля доступа
...
Система контроля доступа реализована в виде отдельного модуля `access-control.js`, который интегрирован в ядро приложения. Основные компоненты системы:
